...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PlanFive",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8PlanFive11AppDelegate")
...
SWIFT_CLASS("_TtC8PlanFive12ChartBarCell")
@interface ChartBarCell : Cell
@property (nonatomic, readonly, strong) UIView * _Nonnull colorBarView;
...
SWIFT_CLASS("_TtC8PlanFive10HeaderCell")
...
SWIFT_CLASS("_TtC8PlanFive8TaskCell")
@interface TaskCell : Cell
@property (nonatomic, readonly, strong) UILabel * _Nonnull label;
@property (nonatomic) CGRect frame;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8PlanFive8TextCell")
...
@interface UIView (SWIFT_EXTENSION(PlanFive))
...
SWIFT_CLASS("_TtC8PlanFive14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) SpreadsheetView * _Null_unspecified spreadsheetView;
@property (nonatomic, readonly, strong) UIView * _Nonnull TitleView;
@property (nonatomic, strong) NSMutableArray * _Nonnull leftDate;
@property (nonatomic, strong) NSArray * _Nonnull fiveTask;
- (void)viewDidLoad;
